...
// import { getResponse } from "../features/chat/chatSlice";
...
//   //   { user: "me", text: "Hi there!" },
   
//   // ]);
//   const dispatch = useDispatch();
//     const [input, setInput] = useState("");
//     // ✅ Access both messages & activeThreadId from Redux
//     const {activeThreadId}=useSelector((state)=>state.chat)
    

//   const { messages, chatstatus } = useSelector((state) => state.chat);
//   const handleSend = () => {
...
//       {/* Main chat messages section */}
//       <div className="chat-content">
//         <Chat messages={messages} />
//         {chatstatus === "loading" && (
//   <div className="typing-indicator">Assistant is searching...</div>
// )}
//       </div>
